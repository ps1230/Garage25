...
namespace Garage25.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VehicleId,Color,Brand,Model,WheelCount,RegistrationNumber,ParkTime,MemberId,VehicleTypeId")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VehicleId,Color,Brand,Model,WheelCount,RegistrationNumber,ParkTime,MemberId,VehicleTypeId")] Vehicle vehicle)
        {
            if (ModelState.IsValid)
            {
